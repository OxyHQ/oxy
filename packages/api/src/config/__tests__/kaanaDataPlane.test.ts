...
const COMPLETE = {
  [KAANA_BASE_URL_VARIABLE]: 'https://kaana.ai',
...
describe('a complete configuration', () => {
  it('resolves an Ed25519 key at the exact canonical origin', () => {
    configure(COMPLETE);
    ...
    expect(resolution.config.baseUrl).toBe('https://kaana.ai');
  ...
  it.each([
    ...
    'https://kaana.ai:443',
    'HTTPS://KAANA.AI',
    'https://kaana.ai/internal',
    'https://kaana.ai?next=https://evil.example',
    'https://kaana.ai#evil',
    'https://user@kaana.ai',
    'https://kaana.ai@evil.example',
    'https://www.kaana.ai',
    'https://kaana.ai.evil.example',
  ])('refuses a non-canonical or credential-bearing Kaana URL: %s', (baseUrl) => {
    configure({ ...COMPLETE, [KAANA_BASE_URL_VARIABLE]: baseUrl });
