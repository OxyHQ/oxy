...
const DEPLOYMENT_ADMIN_COLUMNS = {
  ...
  routingFundingClass: inferenceDeploymentRoutingScores.fundingClass,
  routingFundingState: inferenceDeploymentRoutingScores.fundingState,
  routingFundingEvidenceRef: inferenceDeploymentRoutingScores.fundingEvidenceRef,
  routingFundingRemaining: inferenceDeploymentRoutingScores.fundingRemaining,
  routingFundingRemainingUnit: inferenceDeploymentRoutingScores.fundingRemainingUnit,
  routingFundingObservedAt: inferenceDeploymentRoutingScores.fundingObservedAt,
  routingFundingValidUntil: inferenceDeploymentRoutingScores.fundingValidUntil,
