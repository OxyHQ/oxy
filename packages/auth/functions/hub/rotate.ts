/**
 * `POST /hub/rotate` — a Cloudflare Pages Functions DIRECTORY route.
 *
...
import { handleHubRotate } from '../../hub/handlers';
...
export async function onRequestPost(context: {
  ...
  return handleHubRotate(context.request, context.env);
}
