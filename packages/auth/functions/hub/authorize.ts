/**
 * `POST /hub/authorize` — a Cloudflare Pages Functions DIRECTORY route.
 *
...
import { handleHubAuthorize } from '../../hub/handlers';
...
export async function onRequestPost(context: {
  ...
  return handleHubAuthorize(context.request, context.env);
}
