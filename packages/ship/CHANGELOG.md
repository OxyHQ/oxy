...
`@oxyhq/ship` is now Apache-2.0. The code, the API surface and the behaviour are
...
`@oxyhq/ship` is below 1.0.0, where semver puts the breaking position in the minor
