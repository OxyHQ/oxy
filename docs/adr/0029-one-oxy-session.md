...
- Status: accepted; D1 is implemented, and D3's web account (username, passkey, recovery email; recovery by email; deletion with the passkey); linking Commons, D2 and D4 are being built in follow-up changes
- Date: 2026-09-26
