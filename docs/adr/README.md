...
| [0011](0011-inference-data-plane-name.md) | #972 | Historical naming decision, superseded on 2026-09-02: the inference data plane is Kaana and its only canonical signed origin is `https://kaana.ai`. The retained file is migration history, not current naming authority. |
