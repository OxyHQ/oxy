...
| [0019](0019-kaana-byok-custody.md) | #972 | Every provider credential, including BYOK, lives as KMS ciphertext in Kaana PostgreSQL; Oxy stores only customer-facing metadata plus an opaque handle and revision. Kaana source is merged; the Oxy cut and production gates remain pending. |
