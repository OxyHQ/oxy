...
```
APP_NAME=Alia
SCOPES=user:read,inference:invoke,capabilities:read,capability-tickets:issue,clarity:search,inference:models:read,inference:usage:read,inference:routing:read
